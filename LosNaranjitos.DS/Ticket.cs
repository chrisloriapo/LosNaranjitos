...
namespace LosNaranjitos.DS
{
    public class Ticket
    {
        ...
        int maxCar = 47, cortar;//Para una impresora ticketera que imprime a 40 columnas. La variable cortar cortara el texto cuando rebase el limte.
        ...
        public void CortaTicket()
        {
            ...
            linea.AppendLine("\x1B" + "d" + "\x01"); //Avanza 9 renglones, Tambien varian
        }
        //Para abrir el cajon
